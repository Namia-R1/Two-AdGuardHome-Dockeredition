...
以下是提供的DNS主和备服务器地址及其对应的服务提供商或用途说明：
...
13. **114.114.115.115**  
   - **服务商**：114DNS  
   - **特点**：114DNS的备用服务器，国内常用DNS。

14. **52.80.52.52**  
   - **服务商**：腾讯云DNS  
   - **特点**：腾讯云提供的DNS服务，适合国内用户。

---

### **国际DNS主服务器**
1. **8.8.8.8**  
   - **服务商**：Google Public DNS  
   - **特点**：全球广泛使用，稳定性高。
...
7. **8.8.4.4**  
   - **服务商**：Google Public DNS  
   - **特点**：Google DNS的备用服务器，全球广泛使用。

8. **1.0.0.1**  
   - **服务商**：Cloudflare DNS  
   - **特点**：Cloudflare DNS的备用服务器，隐私保护强。

9. **45.11.45.11**  
   - **服务商**：Unknown（可能为私有DNS）  
   - **特点**：非常规DNS，不建议日常使用。

10. **94.140.15.15**  
   - **服务商**：AdGuard DNS  
   - **特点**：AdGuard DNS的备用服务器，支持广告拦截。
